...
public interface RaceDataClients {
    ...
    interface SessionClient {
        ...
        @GetExchange("/sessions")
        List<MeetingDTO> getSessionsByKey(@RequestParam("meeting_key") Integer meeting_key);
    }

    interface SessionResultClient {
        @GetExchange("/session_result")
        List<SessionResultDTO> getSessionResults(@RequestParam("session_key") Integer session_key);
    }

    interface LapClient {
        @GetExchange("/laps")
        List<LapDTO> getLapResults(@RequestParam("session_key") Integer session_key);
